...
file.remove("./datos/pruebas/mtcars.xlsx")   #- xq no funciona
...
#- guaardar en formato .rds
saveRDS(iris, "./datos/pruebas/iris.rds")            #- con base-R
readr::write_rds(iris, "./datos/pruebas/iris.rds")   #- con pkg "readr"
rio::export(mtcars, "./datos/pruebas/iris_2.rds")    #- con "rio"
